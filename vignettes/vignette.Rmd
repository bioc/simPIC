...
[vignette](https://github.com/Zhen-Miao/PICsnATAC/blob/main/vignettes/Run_PIC_counting_on_pbmc_3k_data.ipynb). Briefly, you need three input files for PIC -
...
For more details about the `r BiocStyle::Biocpkg("SingleCellExperiment")` object refer to the
[vignette](https://www.bioconductor.org/packages/devel/bioc/vignettes/SingleCellExperiment/inst/doc/intro.html).
